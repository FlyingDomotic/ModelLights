...
- `Display tables after loading` display tables content after loading them,
...
- `/command/enable/table` : arms `Display table after loading` flag,
...
- `/command/disable/table` : disarms `Display table after loading` flag,
